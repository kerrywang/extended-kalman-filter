...
In this project, i implemented a extended kalman filter that deals with both lidar data
and radar data. the result is as follow

![Result Demo](output/demo.gif)
